...
public enum SkeletonConfigValue {
	...
	CHEST(4, "Chest", "chestDistance", "Chest distance", 0.32f,
	...
	WAIST(5, "Waist", "waistDistance", "Waist distance", 0.04f,
			new SkeletonNodeOffset[] { SkeletonNodeOffset.WAIST, SkeletonNodeOffset.HIP }),
	HIP_OFFSET(6, "Hip offset", "hipOffset", "Hip offset", 0.0f,
			new SkeletonNodeOffset[] { SkeletonNodeOffset.HIP_TRACKER }),
	HIPS_WIDTH(7, "Hips width", "hipsWidth", "Hips width", 0.26f,
			new SkeletonNodeOffset[] { SkeletonNodeOffset.LEFT_HIP, SkeletonNodeOffset.RIGHT_HIP }),
	LEGS_LENGTH(8, "Legs length", "legsLength", "Legs length", 0.92f,
			new SkeletonNodeOffset[] { SkeletonNodeOffset.KNEE }),
	KNEE_HEIGHT(9, "Knee height", "kneeHeight", "Knee height", 0.50f,
			new SkeletonNodeOffset[] { SkeletonNodeOffset.KNEE, SkeletonNodeOffset.ANKLE }),
	FOOT_LENGTH(10, "Foot length", "footLength", "Foot length", 0.05f,
			new SkeletonNodeOffset[] { SkeletonNodeOffset.FOOT }),
	FOOT_OFFSET(11, "Foot offset", "footOffset", "Foot offset", -0.05f,
			new SkeletonNodeOffset[] { SkeletonNodeOffset.ANKLE }),
	SKELETON_OFFSET(12, "Skeleton offset", "skeletonOffset", "Skeleton offset", 0.0f,
	...
	CONTROLLER_DISTANCE_Z(13, "Controller distance z", "controllerDistanceZ", "Controller distance z", 0.15f,
			new SkeletonNodeOffset[] { SkeletonNodeOffset.CONTROLLER, SkeletonNodeOffset.HAND }),
	CONTROLLER_DISTANCE_Y(14, "Controller distance y", "controllerDistanceY", "Controller distance y", 0.05f,
			new SkeletonNodeOffset[] { SkeletonNodeOffset.CONTROLLER, SkeletonNodeOffset.HAND }),
	FOREARM_LENGTH(15, "Forearm length", "forearmLength", "Forearm length", 0.25f,
			new SkeletonNodeOffset[] { SkeletonNodeOffset.FOREARM_CONTRL, SkeletonNodeOffset.FOREARM_HMD }),
	SHOULDERS_DISTANCE(16, "Shoulders distance", "shoulersDistance", "Shoulders distance", 0.08f,
			new SkeletonNodeOffset[] { SkeletonNodeOffset.LEFT_SHOULDER, SkeletonNodeOffset.RIGHT_SHOULDER }),
	SHOULDERS_WIDTH(17, "Shoulders width", "shoulersWidth", "Shoulders width", 0.36f,
			new SkeletonNodeOffset[] { SkeletonNodeOffset.LEFT_SHOULDER, SkeletonNodeOffset.RIGHT_SHOULDER }),
	UPPER_ARM_LENGTH(18, "Upper arm length", "upperArmLength", "Upper arm length", 0.25f,
			new SkeletonNodeOffset[] { SkeletonNodeOffset.UPPER_ARM }),
	ELBOW_OFFSET(19, "Elbow offset", "elbowOffset", "Elbow offset", 0f,
	...
	SkeletonConfigValue(int id, String stringVal, String configKey, String label, float defaultValue,
