...
public class ReferenceAdjustedTracker<E extends Tracker> implements Tracker {
	...
	/**
	 * Reset the tracker so that it's current rotation is counted as (0, <HMD Yaw>,
	 * 0). This allows tracker to be strapped to body at any pitch and roll.
	 * <p>
	...
	/**
	 * Reset the tracker so that it's current yaw rotation is counted as <HMD Yaw>.
	 * This allows the tracker to have yaw independent of the HMD. Tracker should
	 * still report yaw as if it was mounted facing HMD, mounting position should be
