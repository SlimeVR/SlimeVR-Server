...
fun shouldLock(
	...
	(velocity.horizontalDistance <= SKATING_DISTANCE_THRESHOLD * thresholdMultiplier) &&
...
class FloorClipProcessor : SkeletonProcessor {
	...
	fun getDisplacement(footPos: Vector3): Vector3 {
		return Vector3(0f, footPos.y.coerceAtMost(0f), 0f)
	}
