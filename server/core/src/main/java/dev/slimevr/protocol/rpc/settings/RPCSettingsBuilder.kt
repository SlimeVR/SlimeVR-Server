...
object RPCSettingsBuilder {
	...
	fun createAutoBoneSettings(fbb: FlatBufferBuilder, autoBoneConfig: AutoBoneConfig): Int = AutoBoneSettings
	...
	fun readAutoBoneSettings(
		...
		if (autoBoneSettings.hasOffsetSlideErrorFactor()) {
			autoBoneConfig.offsetSlideErrorFactor = autoBoneSettings.offsetSlideErrorFactor()
		}
		if (autoBoneSettings.hasFootHeightOffsetErrorFactor()) {
			autoBoneConfig
				.footHeightOffsetErrorFactor = autoBoneSettings.footHeightOffsetErrorFactor()
		}
