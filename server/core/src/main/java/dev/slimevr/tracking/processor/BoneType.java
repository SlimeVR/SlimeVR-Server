...
public enum BoneType {
	...
	LEFT_TOES_ABDUCTOR_HALLUCIS_TRACKER,
	LEFT_TOES_ABDUCTOR_HALLUCIS(BodyPart.LEFT_TOES_ABDUCTOR_HALLUCIS),
	LEFT_TOES_DIGITORUM_BREVIS_TRACKER,
	LEFT_TOES_DIGITORUM_BREVIS(BodyPart.LEFT_TOES_DIGITORUM_BREVIS),
	LEFT_TOES_ABDUCTOR_DIGITI_MINIMI_TRACKER,
	LEFT_TOES_ABDUCTOR_DIGITI_MINIMI(BodyPart.LEFT_TOES_ABDUCTOR_DIGITI_MINIMI),
	RIGHT_TOES_ABDUCTOR_HALLUCIS_TRACKER,
	RIGHT_TOES_ABDUCTOR_HALLUCIS(BodyPart.RIGHT_TOES_ABDUCTOR_HALLUCIS),
	RIGHT_TOES_DIGITORUM_BREVIS_TRACKER,
	RIGHT_TOES_DIGITORUM_BREVIS(BodyPart.RIGHT_TOES_DIGITORUM_BREVIS),
	RIGHT_TOES_ABDUCTOR_DIGITI_MINIMI_TRACKER,
	RIGHT_TOES_ABDUCTOR_DIGITI_MINIMI(BodyPart.RIGHT_TOES_ABDUCTOR_DIGITI_MINIMI);
