...
object CenterYaw {
	...
	fun ofSkeleton(
		...
		upperBody.forEach {
			averageYaw.add(trackerYaw(it), CENTER_ERROR_UPPER_BODY_WEIGHT / upperBody.size)
		}

		averageYaw.add(trackerYaw(leftUpperLeg), CENTER_ERROR_UPPER_LEG_WEIGHT * 0.5f)
		averageYaw.add(trackerYaw(rightUpperLeg), CENTER_ERROR_UPPER_LEG_WEIGHT * 0.5f)

		averageYaw.add(trackerYaw(leftLowerLeg), CENTER_ERROR_LOWER_LEG_WEIGHT * 0.5f)
		averageYaw.add(trackerYaw(rightLowerLeg), CENTER_ERROR_LOWER_LEG_WEIGHT * 0.5f)
