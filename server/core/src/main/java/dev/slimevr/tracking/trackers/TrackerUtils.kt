...
object TrackerUtils {
	...
	val allBodyPartsButFingers = listOf(
		...
		BodyPart.LEFT_FOOT, BodyPart.LEFT_TOES_ABDUCTOR_HALLUCIS, BodyPart.LEFT_TOES_DIGITORUM_BREVIS, BodyPart.LEFT_TOES_ABDUCTOR_DIGITI_MINIMI,
		BodyPart.RIGHT_FOOT, BodyPart.RIGHT_TOES_ABDUCTOR_HALLUCIS, BodyPart.RIGHT_TOES_DIGITORUM_BREVIS, BodyPart.RIGHT_TOES_ABDUCTOR_DIGITI_MINIMI,
	)
	...
	val allBodyPartsButFingersAndFeets = listOf(
		...
		BodyPart.LEFT_UPPER_ARM, BodyPart.RIGHT_UPPER_ARM, BodyPart.LEFT_HAND,
		BodyPart.RIGHT_HAND, BodyPart.LEFT_SHOULDER, BodyPart.RIGHT_SHOULDER,
		BodyPart.LEFT_TOES_ABDUCTOR_HALLUCIS, BodyPart.LEFT_TOES_DIGITORUM_BREVIS, BodyPart.LEFT_TOES_ABDUCTOR_DIGITI_MINIMI,
		BodyPart.RIGHT_TOES_ABDUCTOR_HALLUCIS, BodyPart.RIGHT_TOES_DIGITORUM_BREVIS, BodyPart.RIGHT_TOES_ABDUCTOR_DIGITI_MINIMI,
	)
	...
	val allToes = listOf(
		BodyPart.LEFT_TOES_ABDUCTOR_HALLUCIS, BodyPart.LEFT_TOES_DIGITORUM_BREVIS,
		BodyPart.LEFT_TOES_ABDUCTOR_DIGITI_MINIMI, BodyPart.RIGHT_TOES_ABDUCTOR_HALLUCIS,
		BodyPart.RIGHT_TOES_DIGITORUM_BREVIS, BodyPart.RIGHT_TOES_ABDUCTOR_DIGITI_MINIMI,
	)
}
