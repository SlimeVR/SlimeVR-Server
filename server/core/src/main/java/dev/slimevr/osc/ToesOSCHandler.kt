	...
	public override fun update() {
		...
		try {
			...
			trackers.getBone(BoneType.LEFT_FOOT)?.let { leftFoot ->
				val leftToes = listOf(
					trackers.getBone(BoneType.LEFT_TOES_ABDUCTOR_HALLUCIS),
					trackers.getBone(BoneType.LEFT_TOES_DIGITORUM_BREVIS),
					trackers.getBone(BoneType.LEFT_TOES_ABDUCTOR_DIGITI_MINIMI)
				)
			...
			trackers.getBone(BoneType.RIGHT_FOOT)?.let { rightFoot ->
				val rightToes = listOf(
					trackers.getBone(BoneType.RIGHT_TOES_ABDUCTOR_HALLUCIS),
					trackers.getBone(BoneType.RIGHT_TOES_DIGITORUM_BREVIS),
					trackers.getBone(BoneType.RIGHT_TOES_ABDUCTOR_DIGITI_MINIMI)
				)
