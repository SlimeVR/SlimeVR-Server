...
private val AXES_OFFSET = Quaternion.fromRotationVector(-PI.toFloat() / 2f, 0f, 0f)
	...
	return when (packetType) {
		...
		0 -> {
			...
			HIDDeviceInfo(
				...
				firmwareVersion = "%d.%d.%d".format(fwMajor, fwMinor, fwPatch),
				firmwareDate = "%04d-%02d-%02d".format(fwYear, fwMonth, fwDay),
