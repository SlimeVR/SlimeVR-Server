...
onboarding-automatic_proportions-preparation-description = Stellen Sie sich einen Stuhl direkt hinter sich in Ihren Spielbereich und seien Sie bereit, sich während der Autobone-Einrichtung hinzusetzen.
...
onboarding-automatic_proportions-recording-steps-0 = Gehen Sie ein paarmal die Knie ohne Ihre Füße yu bewegen.
