...
settings-serial-enter_pairing = Entrar al emparejamiento
settings-serial-exit_pairing = Salir del emparejamiento
settings-serial-calibrate = Calibrar
...
tracking_checklist-STEAMVR_DISCONNECTED-driver_blocked-desc = El controlador ha sido bloqueado por SteamVR debido a un fallo previo de SteamVR.
