...
settings-general-fk_settings-velocity_settings-send_derived_velocity = Envoyer la vélocité dérivée au pilote
...
settings-serial-enter_pairing = Entrer en mode appariement
settings-serial-exit_pairing = Sortir du mode appariement
settings-serial-calibrate = Calibrer
settings-serial-six_side_calibrate = Calibration à 6 faces
settings-serial-dfu = Entrer en mode DFU
settings-serial-meow = Miaou !
...
tracking_checklist-STEAMVR_DISCONNECTED-driver_blocked-desc = Le pilote a été bloqué par SteamVR à cause d’un plantage de SteamVR.
tracking_checklist-STEAMVR_DISCONNECTED-driver_disabled-desc = Le pilote est désactivé dans les paramètres de SteamVR.
tracking_checklist-STEAMVR_DISCONNECTED-driver_not_installed-desc = Le pilote n’est pas installé.
tracking_checklist-STEAMVR_DISCONNECTED-open = Lancer SteamVR
tracking_checklist-STEAMVR_DISCONNECTED-enable = Activer le pilote
...
tracking_checklist-STANDABLE_INSTALLED = Standable est installé
tracking_checklist-STANDABLE_INSTALLED-desc =
    Standable cause fréquemment des problèmes de suivi lorsqu’il est utilisé avec SlimeVR. Standable devrait être complètement désinstallé sur Steam pour éviter tout problème.
    Vous devez fermer SteamVR avant de désinstaller Standable dans Steam.
