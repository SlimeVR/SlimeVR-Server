...
skeleton_bone-CHEST_OFFSET-desc =
    ...
    ในการปรับเทียบสำหรับบางเกมหรือแอปพลิเคชั่นที่กำหนดตำแหน่งแทร็กเกอร์สูงกว่า หรือต่ำกว่า
...
skeleton_bone-HIP_OFFSET-desc =
    ...
    เพื่อช่วยในการปรับเทียบสำหรับบางเกมหรือแอปพลิเคชั่นที่กำหนดตำแหน่งแทร็กเกอร์ให้อยู่ที่สะโพก
