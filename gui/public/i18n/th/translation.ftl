...
onboarding-setup_warning =
    ...
    จำเป็นต้องดำเนินการหานี่เป็นครั้งแรกที่คุณใช้ SlimeVR
...
onboarding-assignment_tutorial-done = ฉันแปะสติ๊กเกอร์และใส่สายรัดแล้ว!
...
onboarding-automatic_mounting-mounting_reset-title = การปรับเทียบการติดตั้ง
...
onboarding-automatic_proportions-requirements-descriptionv2 =
    คุณมีแทร็กเกอร์พียงพอต่อการติดตามเท้าของคุณเป็นอย่างน้อย (โดยทั่วไปคือ 5 ตัว)
    คุณได้สวมใส่แทร็กเกอร์และแว่น VR เรียบร้อยแล้ว
    แทร็กเกอร์และแว่นของคุณเชื่อมต่อกับเซิร์ฟเวอร์ SlimeVR และทำงานได้อย่างถูกต้อง (เช่น ไม่กระตุก, ไม่หลุดการเชื่อมต่อ, เป็นต้น)
...
onboarding-automatic_proportions-check_height-title-v3 = วัดความสูงของอุปกรณ์สวมศีรษะ
onboarding-automatic_proportions-check_height-description-v2 = ความสูงของอุปกรณ์สวมศีรษะ (HMD) ควรจะต่ำกว่าความสูงจริงของคุณเล็กน้อย เนื่องจากอุปกรณ์สวมศีรษะจะวัดความสูงระดับสายตา การวัดนี้จะถูกใช้เป็นพื้นฐานสำหรับการคำนวณสัดส่วนร่างกายของคุณ
# All the text is in bold!
onboarding-automatic_proportions-check_height-calculation_warning-v3 = ให้เริ่มต้นการวัดในขณะที่ยืนตัว<u>ตรง</u>เพื่อวัดความสูงของคุณ ระวังอย่าให้มือของคุณยกสูงเกินอุปกรณ์สวมศีรษะ เพราะอาจส่งผลต่อการวัด!
onboarding-automatic_proportions-check_height-guardian_tip = หากคุณใช้อุปกรณ์ VR แบบเดี่ยวๆ โปรดตรวจสอบให้แน่ใจว่าได้เปิดใช้งาน Guardian /Boundary เพื่อให้การวัดความสูงถูกต้อง!
# Context is that the height is unknown
onboarding-automatic_proportions-check_height-unknown = ไม่ทราบ
# Shows an element below it
onboarding-automatic_proportions-check_height-hmd_height2 = ความสูงของอุปกรณ์สวมศีรษะคุณคือ:
...
onboarding-automatic_proportions-check_height-next_step = ใช้ความสูงจากอุปกรณ์สวมศีรษะคุณ
...
onboarding-stay_aligned-verify_mounting-title = ปรับเทียบการติดตั้งแทร็กเกอร์
