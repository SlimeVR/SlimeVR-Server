...
onboarding-scaled_proportions-manual_height-missing_steamvr = SteamVR ไม่ได้เชื่อมต่อกับ SlimeVR อยู่ในขณะนี้ ดังนั้นการวัดจึงไม่สามารถอ้างอิงจากอุปกรณ์สวมศีรษะของคุณได้ <b>ดำเนินการต่อด้วยความเสี่ยงของคุณเอง หรือตรวจสอบเอกสาร!</b>
...
onboarding-stay_aligned-verify_mounting-title = การปรับเทียบการติดตั้ง
...
onboarding-stay_aligned-relaxed_poses-sitting-title = ท่านั่งเก้าอี้แบบผ่อนคลาย
...
onboarding-stay_aligned-relaxed_poses-flat-title = ท่านั่งพื้นแบบผ่อนคลาย
...
firmware_tool-flash_method_step-serial-v2 =
    .label = USB
    .description = ใช้สาย USB เพื่ออัปเดตตัตแทร็กเกอร์ของคุณ
...
tracking_checklist-MOUNTING_CALIBRATION = ปรับเทียบการติดตั้งแล้ว
tracking_checklist-FEET_MOUNTING_CALIBRATION = ปรับเทียบการติดตั้งแทร็กเกอร์เท้าแล้ว
tracking_checklist-FULL_RESET = ทำการรีเซ็ตแทร็กเกอร์ทั้งหมดแล้ว
tracking_checklist-FULL_RESET-desc = แทร็กเกอร์บางส่วนจำเป็นต้องทำการรีเซ็ต
tracking_checklist-STEAMVR_DISCONNECTED = SteamVR ไม่ได้ทำงาน
...
tracking_checklist-VRCHAT_SETTINGS = กำหนดค่าการตั้งค่า VRChat
tracking_checklist-VRCHAT_SETTINGS-desc = คุณกำหนดค่าการตั้งค่า VRChat ไม่ถูกต้อง! ซึ่งอาจส่งผลเสียต่อการจับตำแหน่งของแทร็กเกอร์คุณ
tracking_checklist-VRCHAT_SETTINGS-open = ไปยังคำเตือนการตั้งค่า VRChat
tracking_checklist-UNASSIGNED_HMD = อุปกรณ์สวมศีรษะ VR ไม่ได้ถูกกำหนดที่ส่วนหัว
tracking_checklist-UNASSIGNED_HMD-desc = ควรระบุอุปกรณ์สวมศีรษะ VR ให้เป็นแทร็กเกอร์ส่วนหัว
