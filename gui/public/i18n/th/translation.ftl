...
onboarding-calibration_tutorial-status-waiting = ฉันรอคุณอยู่
onboarding-calibration_tutorial-status-calibrating = กำลัง Calibrate
onboarding-calibration_tutorial-status-success = เยี่ยม!
onboarding-calibration_tutorial-status-error = แทร็กเกอร์มีการขยับ
