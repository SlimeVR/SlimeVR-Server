...
serial_detection-new_device-p1 = ใส่ข้อมูลประจำตัว WiFi ของคุณ!
...
onboarding-wifi_creds = ใส่ข้อมูลประจำตัว Wi-Fi
# This cares about multilines
...
onboarding-connect_tracker-connection_status-provisioning = กำลังส่งข้อมูลประจำตัว Wi-Fi
...
onboarding-assign_trackers-back = กลับไปยังการตั้งค่าข้อมูลประจำตัว Wi-Fi
...
onboarding-automatic_proportions-check_height-guardian_tip = หากคุณใช้เฮดเซ็ท VR แบบเดี่ยวๆ โปรดตรวจสอบให้แน่ใจว่าได้เปิดใช้งาน Guardian /Boundary เพื่อให้การวัดความสูงถูกต้อง!
...
firmware_tool-not_compatible = เครื่องมือเฟิร์มแวร์ไม่เข้ากันกับ SlimeVR Server เวอร์ชันนี้ โปรดอัพเดท SlimeVR Server ของคุณ!
...
firmware_tool-flash_method_serial-wifi = ข้อมูลประจำตัว Wi-Fi:
