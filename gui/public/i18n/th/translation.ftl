...
tracker-settings-mounting_section-description = แทร็กเกอร์นี่อยู่ด้านไหนของคุณ?
...
tracker-settings-use_mag = เปิดใช้งานเซนเซอร์สนามแม่เหล็กสำหรับแทร็กเกอร์ตัวนี้
# Multiline!
tracker-settings-use_mag-description =
    ให้แทร็กเกอร์ตัวนี้เปิดใช้งานเซนเซอร์สนามแม่เหล็กเพื่อลดการดริฟท์หรือไม่? <b> โปรดอย่าปิดแทร็กเกอร์ของคุณในขณะที่กำลังสลับการตั้งค่านี้!</b>
    คุณต้องอนุญาตการใช้เซนเซอร์สนามแม่เหล็กก่อน <magSetting>คลิกที่นี่เพื่อไปที่การตั้งค่า</magSetting>
tracker-settings-use_mag-label = เปิดใช้เซนเซอร์สนามแม่เหล็ก
...
settings-general-tracker_mechanics-use_mag_on_all_trackers = ใช้เซนเซอร์สนามแม่เหล็กบนแทร็กเกอร์ที่ IMU รองรับ
settings-general-tracker_mechanics-use_mag_on_all_trackers-description =
    ใช้เซนเซอร์สนามแม่เหล็กบนแทร็กเกอร์ทั้งหมดที่มีเฟิร์มแวร์ที่เข้ากันได้ ซึ่งช่วยลดดริฟท์ในสภาพแวดล้อมที่มีสนามแม่เหล็กคงที่
...
settings-general-tracker_mechanics-use_mag_on_all_trackers-label = ใช้เซนเซอร์สนามแม่เหล็กกับแทร็กเกอร์
...
settings-general-fk_settings-ik-use_position-description = เปิดใช้งานการใช้ข้อมูลตำแหน่งจากแทร็กเกอร์ที่รองรับ เมื่อเปิดใช้งานแล้วโปรดทำการรีเซ็ตแทร็กเกอร์ทั้งหมด และปรับเทียบใหม่ภายในเกมด้วย
...
settings-general-fk_settings-reset_settings-reset_hmd_pitch-description = รีเซ็ตความเอียง (การหมุนในแนวตั้ง) ของ HMD เมื่อทำการรีเซ็ตแทร็กเกอร์ทั้งหมด มีประโยชน์หากสวม HMD ไว้ที่หน้าผากสำหรับ VTubing หรือ Mocap ไม่ควรเปิดใช้งานสำหรับการใช้งาน VR ทั่วไป
