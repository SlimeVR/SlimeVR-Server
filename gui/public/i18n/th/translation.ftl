...
skeleton_bone-HEAD-desc =
    นี่คือระยะห่างจากเฮดเซ็ตของคุณไปยังกึ่งกลางของศีรษะ
    เพื่อปรับค่า ให้คุณส่ายหัวไปทางซ้ายและขวา ราวกับว่าคุณกำลังส่ายหน้าไม่เห็นด้วย และปรับค่าจนกระทั่งการเคลื่อนไหวของตัวติดตามอื่น ๆ แทบไม่ขยับเลย
...
skeleton_bone-FOOT_LENGTH-desc =
    ...
    ในการปรับ ให้เขย่งเท้าและปรับเปลี่ยนจนกว่าเท้าเสมือนของคุณจะอยู่กับที่
skeleton_bone-FOOT_SHIFT = เปลี่ยนเท้า
skeleton_bone-FOOT_SHIFT-desc =
    ค่านี้คือระยะห่างในแนวนอนจากเข่าถึงข้อเท้า
    มันอธิบายถึงขาส่วนล่างของคุณถอยหลังเมื่อยืนตัวตรง
    หากต้องการปรับ ให้ตั้งค่าความยาวเท้าเป็น 0 ทําการรีเซ็ตทั้งหมดและแก้ไขจนกว่าเสมือนของคุณ
    เท้าอยู่ในแนวเดียวกับกลางข้อเท้าของคุณ
skeleton_bone-SKELETON_OFFSET = กระดูกออฟเซ็ต
skeleton_bone-SHOULDERS_DISTANCE = ระยะไหล่
skeleton_bone-SHOULDERS_DISTANCE-desc =
    นี่คือระยะทางแนวตั้งจากโคนคอถึงไหล่
    ในการปรับ ให้ตั้งค่าความยาวต้นแขนเป็น 0 และแก้ไขจนกว่าตัวติดตามข้อศอกเสมือนจริงของคุณ
    จัดเรียงในแนวตั้งกับไหล่จริงของคุณ
skeleton_bone-SHOULDERS_WIDTH = ความกว่างไหล่
skeleton_bone-SHOULDERS_WIDTH-desc =
    นี่คือระยะห่างในแนวนอนจากโคนคอถึงไหล่
    ในการปรับ ให้ตั้งค่าความยาวต้นแขนเป็น 0 และแก้ไขจนกว่าตัวติดตามข้อศอกเสมือนจริงของคุณ
    จัดเรียงในแนวนอนกับไหล่จริงของคุณ
...
skeleton_bone-LOWER_ARM-desc =
    นี่คือระยะห่างจากข้อศอกถึงข้อมือ
    ในการปรับ ให้ปรับความยาวแขนให้เหมาะสมและปรับเปลี่ยนจนกระทั่ง
    ตัวติดตามข้อศอกของคุณอยู่ในแนวเดียวกับข้อศอกจริงของคุณ
...
reset-reset_all_warning_default-v2 =
    <b>คำเตือน:</b> ความสูงของคุณไม่ได้รับการกําหนดค่าสัดส่วนของคุณจะถูกรีเซ็ตเป็นค่าเริ่มต้นด้วยความสูงเริ่มต้น
    คุณแน่ใจหรือไม่ว่าต้องการทําเช่นนี้?
...
tracker-settings-forget-description = ลบตัว แทรกเก้อ ออกจากเซิร์ฟเวอร์ SlimeVR และป้องกันไม่ให้เชื่อมต่อกับเซิร์ฟเวอร์จนกว่าจะรีสตาร์ทเซิร์ฟเวอร์ การกำหนดค่าของตัวติดตามจะไม่สูญหาย
...
tracker_selection_menu-unassigned = ตัวติดตามที่ไม่ได้มอบหมาย
tracker_selection_menu-assigned = ตัวติดตามที่ได้รับมอบหมาย
tracker_selection_menu-dont_assign = ไม่ได้มอบหมาย
# This line cares about multilines.
# <b>text</b> means that the text should be bold.
tracker_selection_menu-neck_warning =
    <b>คำเตือน:</b> ตัวติดตามคออาจถึงตายได้หากปรับแน่นเกินไป
...
mounting_selection_menu = คุณต้องการให้ตัวติดตามนี้อยู่ที่ไหน
...
settings-sidebar-fk_settings = การตั้งค่าแทรกเก้อ
...
settings-sidebar-serial = คอโซลระบบ
...
settings-general-steamvr-trackers-tracker_toggling-description = จัดการการเปิดหรือปิดตัวติดตาม SteamVR โดยอัตโนมัติขึ้นอยู่กับการมอบหมายตัวติดตามปัจจุบันของคุณ
settings-general-steamvr-trackers-tracker_toggling-label = การกําหนดตัวติดตามอัตโนมัติ
...
settings-general-tracker_mechanics-filtering = กรอง
# This also cares about multilines
settings-general-tracker_mechanics-filtering-description =
    เลือกประเภทการกรองสําหรับตัวติดตามของคุณ
    การคาดการณ์คาดการณ์การเคลื่อนไหวในขณะที่การปรับให้เรียบจะทําให้การเคลื่อนไหวราบรื่น
...
settings-general-fk_settings = การตั้งค่าแทรกเก้อ
# Floor clip:
# why the name - came from the idea of noclip in video games, but is the opposite where clipping to the floor is a desired feature
# definition - Prevents the foot trackers from going lower than they where when a reset was performed
settings-general-fk_settings-leg_tweak-floor_clip = คลิปหนีบพื้น
# Skating correction:
# why the name - without this enabled the feet will often slide across the ground as if your skating across the ground,
# since this largely prevents this it corrects for it hence skating correction (note this may be renamed to sliding correction)
# definition - Guesses when each foot is in contact with the ground and uses that information to improve tracking
settings-general-fk_settings-leg_tweak-skating_correction = การแก้ไขการเล่นสเก็ต
settings-general-fk_settings-leg_tweak-toe_snap = สแน็ปนิ้วเท้า
...
settings-osc-vmc = จับการเคลื่อนไหวเสมือน
settings-osc-vmc-enable = เปิดใช้งาน
settings-osc-vmc-enable-description = สลับการส่งและรับข้อมูล
