...
-tracker_selection-part = どのトラッカーに割り当てるか？
tracker_selection_menu-NONE = どのトラッカーに割り当てないか？
tracker_selection_menu-HEAD = { -tracker_selection-part } 頭?
tracker_selection_menu-NECK = { -tracker_selection-part } 首?
tracker_selection_menu-RIGHT_SHOULDER = { -tracker_selection-part } 右肩?
tracker_selection_menu-RIGHT_UPPER_ARM = { -tracker_selection-part } 右上腕?
tracker_selection_menu-RIGHT_LOWER_ARM = { -tracker_selection-part } 右前腕?
tracker_selection_menu-RIGHT_HAND = { -tracker_selection-part } 右手?
tracker_selection_menu-RIGHT_UPPER_LEG = { -tracker_selection-part } 右太もも?
tracker_selection_menu-RIGHT_LOWER_LEG = { -tracker_selection-part } 右足首?
tracker_selection_menu-RIGHT_FOOT = { -tracker_selection-part } 右足先?
tracker_selection_menu-RIGHT_CONTROLLER = { -tracker_selection-part } 右コントローラ?
tracker_selection_menu-CHEST = { -tracker_selection-part } 胸?
tracker_selection_menu-WAIST = { -tracker_selection-part } 腰?
tracker_selection_menu-HIP = { -tracker_selection-part } ヒップ?
tracker_selection_menu-LEFT_SHOULDER = { -tracker_selection-part } 左肩?
tracker_selection_menu-LEFT_UPPER_ARM = { -tracker_selection-part } 左上腕?
tracker_selection_menu-LEFT_LOWER_ARM = { -tracker_selection-part } 左前腕?
tracker_selection_menu-LEFT_HAND = { -tracker_selection-part } 左手?
tracker_selection_menu-LEFT_UPPER_LEG = { -tracker_selection-part } 左太もも?
tracker_selection_menu-LEFT_LOWER_LEG = { -tracker_selection-part } 左足首?
tracker_selection_menu-LEFT_FOOT = { -tracker_selection-part } 左足先?
tracker_selection_menu-LEFT_CONTROLLER = { -tracker_selection-part } 左コントローラ?
