...
settings-stay_aligned-relaxed_poses-detect_pose = 检测姿势
...
onboarding-stay_aligned-relaxed_poses-standing-step-1 = 2. 检查追踪器位置与身体对应，否则重新进行这个流程。
...
onboarding-stay_aligned-relaxed_poses-sitting-step-1 = 2. 检查追踪器位置与身体对应，否则重新进行这个流程。
...
onboarding-stay_aligned-relaxed_poses-flat-step-1 = 2. 检查追踪器位置与身体对应，否则重新进行这个流程。
