...
firmware_tool-description = 允许您配置和下载 DIY 追踪器固件
...
firmware_tool-select_firmware_step-show-third-party =
    .label = 显示第三方固件
firmware_tool-flash_method_step = 固件下载方式
firmware_tool-flash_method_step-description = 请选择您要使用的固件下载方式
...
firmware_tool-flashbtn_step-board_OTHER =
    在下载固件之前，您可能需要将追踪器置于bootloader模式。  
    通常这意味着在开始固件下载过程之前，按下板上的引导/boot按钮。  
    如果固件下载过程在开始时超时，这通常表示追踪器没有处于bootloader模式。  
    请参考您的追踪器电路板的固件下载说明，了解如何进入bootloader模式。
