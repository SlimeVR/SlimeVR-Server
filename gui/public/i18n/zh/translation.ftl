...
tracker-table-column-battery = 电池
...
settings-osc-router-network-port_out-placeholder = 输出端口（默认 9000）
...
settings-osc-vrchat-network-port_out-label = 输出端口
