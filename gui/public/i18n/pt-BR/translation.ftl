...
settings-general-fk_settings-velocity_settings-send_derived_velocity = Enviar velocidade derivada para o driver.
...
settings-general-fk_settings-arm_fk-back-description = O modo padrão, deixe os cotovelos um pouco dobrados e levemente atrás do tronco, com as mãos mais à frente do corpo.
...
settings-general-gesture_control-yawResetTracker = Redefinir Tracker Rápido
...
settings-general-gesture_control-fullResetTracker = Redefinir Todos os Trackers
