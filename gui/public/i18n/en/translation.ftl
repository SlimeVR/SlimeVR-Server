...
settings-general-gesture_control-yawResetTracker = What tracker do you want to yaw reset with?
...
settings-general-gesture_control-fullResetTracker = What tracker do you want to full reset with?
...
settings-general-gesture_control-mountingResetTracker = What tracker do you want to perform mounting calibration with?
