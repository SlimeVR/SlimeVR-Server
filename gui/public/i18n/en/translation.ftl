...
onboarding-stay_aligned-put_trackers_on-description = To calibrate mounting orientations, we're gonna use the trackers you just assigned. Put on all your trackers, you can see which are which in the figure to the right.
onboarding-stay_aligned-put_trackers_on-trackers_warning = You have less than 5 trackers currently connected and assigned! This is the mimum amount of trackers required for Stay Aligned to function properly.
...
onboarding-stay_aligned-done-description-2 = Everything is now Setup, you may restart the process if you want to re-calibrate the poses
