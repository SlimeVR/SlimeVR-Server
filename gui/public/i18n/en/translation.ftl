...
settings-general-interface-show-navbar-onboarding = Show setup wizard on navbar
settings-general-interface-show-navbar-onboarding-description = This changes if the "Setup Wizard" button shows on the navbar.
