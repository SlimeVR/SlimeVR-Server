...
settings-general-interface-show-navbar-onboarding = Show setup wizard on navigation bar
settings-general-interface-show-navbar-onboarding-description = This changes if the "Setup Wizard" button shows on the navigation bar.
settings-general-interface-show-navbar-onboarding-label = Show setup wizard
