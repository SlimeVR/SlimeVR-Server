...
settings-general-fk_settings-reset_settings-reset_hmd_pitch_roll-description = Reset the HMD's pitch and roll upon doing a full reset. Useful if wearing an HMD on the forehead for VTubing or mocap. Do not enable for VR.
settings-general-fk_settings-reset_settings-reset_hmd_pitch_roll = Reset HMD pitch and roll
