...
onboarding-automatic_proportions-check_height-guardian_tip = If you are using an standalone VR, be sure to have your guardian/
    boundary turned on so your height is correct!
