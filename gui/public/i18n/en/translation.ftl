...
tracking_checklist-STEAMVR_HANDS_ENABLED-desc = You have enabled the SteamVR hand trackers even though you have real controllers connected. This will cause button inputs to not work in SteamVR and in games.
