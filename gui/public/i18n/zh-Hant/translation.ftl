...
onboarding-stay_aligned-description = 設定 Stay Aligned 讓追蹤器對齊你的姿勢。
onboarding-stay_aligned-verify_mounting-title = 確認追蹤器的配戴狀態
onboarding-stay_aligned-verify_mounting-step-0 = Stay Aligned 需要追蹤器配戴良好，否則體驗會不如預期。
...
onboarding-stay_aligned-relaxed_poses-standing-step-1 = 2. 檢查虛擬追蹤器的位置是否與身體貼合，如果沒有，請調整追蹤器並重新開始整個設定流程。
onboarding-stay_aligned-relaxed_poses-standing-step-2 = 3. 請按下「偵測姿勢」按鈕。
...
onboarding-stay_aligned-relaxed_poses-sitting-step-1 = 2. 檢查虛擬追蹤器的位置是否與身體貼合，如果沒有，請調整追蹤器並重新開始整個設定流程。
onboarding-stay_aligned-relaxed_poses-sitting-step-2 = 3. 請按下「偵測姿勢」按鈕。
...
onboarding-stay_aligned-relaxed_poses-flat-step-1 = 2. 檢查虛擬追蹤器的位置是否與身體貼合，如果沒有，請調整追蹤器並重新開始整個設定流程。
onboarding-stay_aligned-relaxed_poses-flat-step-2 = 3. 請按下「偵測姿勢」按鈕。
onboarding-stay_aligned-relaxed_poses-skip_step = 跳過
onboarding-stay_aligned-done-title = Stay Aligned 已啟用！
onboarding-stay_aligned-done-description = 設定完成！當你處於設定的姿勢時，追蹤器將會對齊你先前設定的姿勢來補正。
