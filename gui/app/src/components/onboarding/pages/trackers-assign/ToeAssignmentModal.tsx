      ...
      >
        <div className="flex w-full flex-col items-center gap-6 px-4">
          <Typography variant="main-title" bold>
            {sideLabel} Foot ΓÇö Toe Assignment
          </Typography>
          ...
          <div
            ref={containerRef}
            className="flex flex-row items-center gap-10 relative"
          >
            <canvas
              ref={canvasRef}
            ...
            <div
              ref={cardsRef}
              className="flex flex-col gap-4 min-w-[180px] z-10"
            >
              {toeParts.map(({ part }) => (
                <div
                  key={part}
                  ...
                  className={classNames(
                    ...
                    assignedRoles.includes(part) &&
                      'border border-status-success border-opacity-50'
                  )}
            ...
            <div
              ref={footRef}
              className="relative flex-shrink-0 fill-background-30 z-10"
            >
