...
settings-osc-vmc-vrm-description = Load a VRM model to use its own bone proportions and enable a higher compatibility with other applications.
...
settings-osc-vmc-anchor_hip-description = When enabled, the avatar stays pinned at its hips and only rotations are sent, useful for seated VTubing. When disabled, the avatar follows your head and moves around.
...
settings-sidebar-osc_custom = Custom OSC
settings-osc-custom = Custom OSC Routing
settings-osc-custom-description = Map tracker position, rotation, and quaternion axes to custom OSC addresses and send data to third-party endpoints.
settings-osc-custom-enable = Enable Custom OSC Output
settings-osc-custom-enable-description = Enable or disable streaming data to all active custom OSC profiles.
settings-osc-custom-profiles = Custom OSC Profiles
settings-osc-custom-add-profile = Add Profile
settings-osc-custom-import-profile = Import Profile
settings-osc-custom-export-profile = Export Profile
settings-osc-custom-no-profiles = No custom OSC profiles configured yet. Click "{settings-osc-custom-import-profile}" or "{settings-osc-custom-export-profile}" to create one.
settings-osc-custom-profile-name = Profile Name
settings-osc-custom-address = Target Address
settings-osc-custom-port = Target Port
settings-osc-custom-trackers = Trackers
settings-osc-custom-add-tracker = Add Tracker Mapping
settings-osc-custom-add-param = Add Parameter Row
settings-osc-custom-axis = Axis Source
settings-osc-custom-osc-address = OSC Address String
settings-osc-custom-delete = Delete
settings-osc-custom-edit = Edit Profile
settings-osc-custom-save = Save Profile
settings-osc-custom-cancel = Cancel
...
onboarding-assign_trackers-toes-middle = Middle toes
onboarding-assign_trackers-toe-big = Big toe
onboarding-assign_trackers-toe-index = Index toe
onboarding-assign_trackers-toe-middle = Middle toe
onboarding-assign_trackers-toe-ring = Ring toe
onboarding-assign_trackers-toe-little = Little toe
