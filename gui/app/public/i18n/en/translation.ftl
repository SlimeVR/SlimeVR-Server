...
settings-osc-custom-no-profiles = No custom OSC profiles configured yet. Click "{ settings-osc-custom-add-profile }" or "{ settings-osc-custom-import-profile }" to create one.
