...
export type VRCConfigState = { isSupported: false } | ({ isSupported: true } & NonNull<Pick<VRCConfigStateChangeResponseT, 'recommended' | 'state' | 'validity'>>)
