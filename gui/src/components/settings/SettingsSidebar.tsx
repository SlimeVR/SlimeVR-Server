            ...
            <SettingsResetModal
              accept={() => {
                ...
                toggles.skatingCorrection =
                  defaultServerConfig.toggles.skatingCorrection;
                toggles.extendedKnee = defaultServerConfig.toggles.extendedKnee;
                toggles.extendedPelvis =
                  defaultServerConfig.toggles.extendedPelvis;
                toggles.extendedSpine =
                  defaultServerConfig.toggles.extendedSpine;
                toggles.forceArmsFromHmd =
                  defaultServerConfig.toggles.forceArmsFromHmd;
                toggles.viveEmulation =
                  defaultServerConfig.toggles.viveEmulation;
                ...
                toggles.selfLocalization =
                  defaultServerConfig.toggles.selfLocalization;
                ...
                ratios.interpKneeAnkle =
                  defaultServerConfig.ratios.interpKneeAnkle;
                ...
                tapDetection.fullResetDelay =
                  defaultServerConfig.tapDetection.fullResetDelay;
                tapDetection.fullResetEnabled =
                  defaultServerConfig.tapDetection.fullResetEnabled;
                tapDetection.fullResetTaps =
                  defaultServerConfig.tapDetection.fullResetTaps;
                tapDetection.yawResetDelay =
                  defaultServerConfig.tapDetection.yawResetDelay;
                tapDetection.yawResetEnabled =
                  defaultServerConfig.tapDetection.yawResetEnabled;
                tapDetection.yawResetTaps =
                  defaultServerConfig.tapDetection.yawResetTaps;
                ...
                driftCompensation.enabled =
                  defaultServerConfig.driftCompensation.enabled;
                driftCompensation.amount =
                  defaultServerConfig.driftCompensation.amount;
                driftCompensation.maxResets =
                  defaultServerConfig.driftCompensation.maxResets;
                ...
                setConfig({
                  ...
                  connectedTrackersWarning:
                    defaultGUIConfig.connectedTrackersWarning,
