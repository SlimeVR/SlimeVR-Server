...
export const UpdateManifestContext = createContext<UpdateManifest | null>(null);
...
const updateManifest=      await Promise.resolve({
        ...
        channels: {
          ...
          nightly: {
            description: 'unstable builds',
            current_version: 'v0.16.1-rc.1',
            versions: {
              'v0.13.0-rc.1': {
                release_notes:
              ...
              'v0.13.0-rc.3': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.13.0-rc.3'],
                    },
                  },
                },
              },
              'v0.13.0-rc.4': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.13.0-rc.4'],
                    },
                  },
                },
              },
              'v0.13.1-rc.1': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.13.1-rc.1'],
                    },
                  },
                },
              },
              'v0.13.1-rc.2': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.13.1-rc.2'],
                    },
                  },
                },
              },
              'v0.13.1-rc.3': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.13.1-rc.3'],
                    },
                  },
                },
              },
              'v0.14.0-rc.2': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.14.0-rc.2'],
                    },
                  },
                },
              },
              'v0.14.0-rc1': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.14.0-rc1'],
                    },
                  },
                },
              },
              'v0.15.0-rc.1': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.15.0-rc.1'],
                    },
                  },
                },
              },
              'v0.15.0-rc.2': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.15.0-rc.2'],
                    },
                  },
                },
              },
              'v0.15.0-rc.3': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.15.0-rc.3'],
                    },
                  },
                },
              },
              'v0.15.0-rc.4': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.15.0-rc.4'],
                    },
                  },
                },
              },
              'v0.16.0-rc.1': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.16.0-rc.1'],
                    },
                  },
                },
              },
              'v0.16.0-rc.2': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.16.0-rc.2'],
                    },
                  },
                },
              },
              'v0.16.1-rc.1': {
                ...
                builds: {
                  windows: {
                    x86_64: {
                      url: 'https://github.com/SlimeVR/SlimeVR-Installer/releases/latest/download/slimevr_web_installer.exe',
                      run: ['$_BINARY_$', '--version', '0.16.1-rc.1'],
                    },
                  },
                },
              },
  ...
  return (
    <UpdateManifestContext.Provider value={updateManifest}>
      <Router>
    ...
    </UpdateManifestContext.Provider>
  );
}
